    ...
    <img src="Stock/GUCERA.png"  alt="Alternate Text" class="user" />
     ...
     <div class="assginmentbox" id="assginmentbox" runat="server" >
           ...
           <form id="form1" runat="server">
                ...
                <asp:Button ID="Button2" runat="server" Text="Back" CssClass="btnback2" OnClick="backbtn" CausesValidation="false" /> 
                <asp:Button ID="Button1" runat="server" Text="Another course" CssClass="btnback3" OnClick="another" CausesValidation="false" />
                <asp:GridView ID="viewAss" runat="server" CssClass="grid" CellPadding="4" ForeColor="#333333" GridLines="None">
