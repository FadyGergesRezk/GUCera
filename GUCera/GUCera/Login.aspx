...
<body>
       ...
       <div class="loginbox"> 
           ...
           <form id="form1" runat="server">
               ...
               <asp:TextBox ID="username" runat="server" CssClass="txtid" placeholder="Enter your ID" /> 
               ...
               <br /> 
               <asp:TextBox ID="password" TextMode="Password"  runat="server" CssClass="txtpass" placeholder="************" /><br />
