    ...
    <div class="gradesbox">
        <img src="Stock/grades.jpg"  alt="Alternate Text" class="grades" />
            <form id="form1" runat="server">
             ...
             <asp:TextBox ID="CourseID" CssClass="txtcid" placeholder="Enter the course id " runat="server" />
             ...
             <asp:TextBox ID="AssNumber" CssClass="txtassnumber" placeholder="Enter the assignment number" runat="server" />
