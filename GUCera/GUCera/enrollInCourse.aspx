     ...
     <img src="Stock/GUCERA.png"  alt="Alternate Text" class="user" />
        ...
        <div class="enrollbox">
          ...
          ID="RequiredFieldValidator1" runat="server" 
            ...
            <asp:TextBox ID="courseIdTextBox" CssClass="txtcid" placeholder="Enter the course id " runat="server" />
          ...
          ID="RequiredFieldValidator2" runat="server" 
            ...
            <asp:TextBox ID="instructorIdTextBox" CssClass="txtinsid" placeholder="Enter the instructor id" runat="server" />
