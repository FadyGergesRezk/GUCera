...
<body>
        ...
        <img src="Stock/admin.png"  alt="Alternate Text" class="addcourse" />
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label4" runat="server" Text="Enter The Discount" CssClass="lbl"></asp:Label>
             <asp:RequiredFieldValidator  runat="server" forecolor="Red" Errormessage="*" ControlToValidate="discount">
            </asp:RequiredFieldValidator>
            <asp:TextBox ID="discount" runat="server" placeholder="Enter Discount amount" CssClass="txt"></asp:TextBox>
