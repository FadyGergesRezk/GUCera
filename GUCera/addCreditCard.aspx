    ...
    <img src="Stock/GUCERA.png"  alt="Alternate Text" class="user" />
     ...
     <div class="creditbox">
         ...
         <form id="form1" runat="server">
            ...
            <asp:TextBox ID="numberTextBox" CssClass="txtnumber" placeholder="Enter the card number " runat="server" />
            ...
            <asp:TextBox ID="cardHolderNameTextBox" CssClass="txtname" placeholder="Enter the card holder's name" runat="server" />
            ...
            <asp:TextBox ID="cvvTextBox" TextMode="Password" CssClass="txtname" placeholder="Enter the card CVV number" runat="server" />
